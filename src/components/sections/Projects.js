        ...
        <Slider>
          <Slide index={0}>
            <div className=''>
              ...
              <button className=''><a href='https://github.com/nuclearsheep540/deepsea' target='_blank' rel='noopener noreferrer'>Read More</a></button>
              <button className=''><a href='https://nuclearsheep540.github.io/deepsea/' target='_blank' rel='noopener noreferrer'>Launch</a></button>
            </div>
          </Slide>
