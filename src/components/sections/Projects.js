        ...
        <Slider>
          <Slide index={0}>
            <div className=''>
              ...
              <p className="h200">Our main focus for this app was integrating open authentication with Spotify to process user
          ...
          <Slide index={1}>
            <div className=''>
              ...
              <p className="h200">Skill Swap is a social platform to enable new and junior developers to meet and support each
          ...
          <Slide index={2}>
            <div className=''>
              ...
              <p className="h200">During this hackathon, I focussed on getting MapboxGL to display music event data as markers,
          ...
          <Slide index={3}>
            <div className=''>
              ...
              <p className="h200">My first project was a cell-based JavaScript game, combining concepts from battleships as well
